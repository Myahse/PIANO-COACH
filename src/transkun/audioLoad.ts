...
/** Same pipeline as loadAudioMono, but from an already-decoded AudioBuffer. */
export async function bufferToMono(buffer: AudioBuffer, targetSampleRate: number): Promise<Float32Array> {
